...
_BitBucket + CodePipeline + Secrets Manager + ECR + ECS Fargate + Application Load Balancer + NAT Gateway_
...
Go to Route 53 and add a new Simple Routing record for the ALB (select YES for Evaluate Target Health)
